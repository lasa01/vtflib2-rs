...
struct VtfLibErrorWrapper(*mut ffi::VTFLibError);

impl VtfLibErrorWrapper {
    fn new() -> Self {
        Self(unsafe { ffi::vlCreateVTFLibError() })
    }

    #[cold]
    fn get(&self) -> Error {
        let cstr = unsafe { CStr::from_ptr(ffi::vlGetErrorMessage(self.0)) };
        Error::VtfLib(cstr.to_string_lossy().into_owned())
    }

    fn ffi_try(f: impl FnOnce(*mut ffi::VTFLibError) -> ffi::vlBool) -> Result<()> {
        let error = Self::new();

        if f(error.0) == ffi::vlFalse {
            Err(error.get())
        } else {
            Ok(())
        }
    ...
    fn ffi_result<P>(f: impl FnOnce(*mut ffi::VTFLibError) -> *mut P) -> Result<*mut P> {
        let error = Self::new();

        let pointer = f(error.0);
...
impl Drop for VtfLibErrorWrapper {
    fn drop(&mut self) {
        unsafe {
            ffi::vlDestroyVTFLibError(self.0);
        }
    }
}
...
macro_rules! ffi_getters {
    (
        $(
            $(#[$meta:meta]) *
            $vis:vis fn $name:ident(&$self:ident$(,$arg:ident: $argty:ty)*) -> $ty:ty => $expr:expr
        ),*
    ) => {
        $(
...
macro_rules! ffi_setters {
    (
        $(
            $(#[$meta:meta]) *
            $vis:vis fn $name:ident(&mut $self:ident$(,$arg:ident: $argty:ty)*) => $stmt:stmt
        ),*
    ) => {
        $(
...
#[must_use]
pub fn get_integer(option: IntegerOption) -> i32 {
...
///
/// # Safety
/// No synchronization, must ensure that other library functions are not called simultaneously.
pub unsafe fn set_integer(option: IntegerOption, value: i32) {
    ffi::vlSetInteger(option as i32, value);
}

/// Get the value of a floating point configuration option.
#[must_use]
pub fn get_float(option: FloatOption) -> f32 {
...
/// # Safety
/// No synchronization, must ensure that other library functions are not called simultaneously.
pub unsafe fn set_float(option: FloatOption, value: f32) {
...
pub enum CubeMapFace {
    ...
    SphereMap = ffi::tagVTFCubeMapFace_CUBEMAP_FACE_SphereMap as u32,
}
...
#[derive(Debug)]
pub struct VtfFile {
    pointer: *mut ffi::VTFLibVTFFile,
}

impl VtfFile {
    pub fn new() -> Self {
        Self {
            pointer: unsafe { ffi::vlCreateVTFFile() },
        }
    }
    ...
    pub fn new_empty(&mut self, width: u32, height: u32) -> EmptyImageBuilder {
        EmptyImageBuilder::new(self, width, height)
    }
    ...
    pub fn from_rgba8888(&mut self, width: u32, height: u32) -> Rgba8888ImageBuilder {
        Rgba8888ImageBuilder::new(self, width, height)
    }
    ...
    fn load_impl(&mut self, bytes: &[u8], header_only: bool) -> Result<()> {
        ...
        VtfLibErrorWrapper::ffi_try(|error| unsafe {
            ffi::vlImageLoadLump(
                self.pointer,
                bytes.as_ptr().cast(),
                len,
    ...
    ffi_getters!(
        ...
        pub fn has_image(&self) -> bool => ffi::vlImageGetHasImage(self.pointer) as u8 == ffi::vlTrue,

        #[doc = "Returns the VTF file major version number."]
        pub fn major_version(&self) -> u32 => ffi::vlImageGetMajorVersion(self.pointer),
        #[doc = "Returns the VTF file minor version number."]
        pub fn minor_version(&self) -> u32 => ffi::vlImageGetMinorVersion(self.pointer),
        #[doc = "Returns the VTF file size in bytes."]
        pub fn size(&self) -> usize => ffi::vlImageGetSize(self.pointer) as usize,

        #[doc = "Returns the width of the image in pixels."]
        pub fn width(&self) -> u32 => ffi::vlImageGetWidth(self.pointer),
        #[doc = "Returns the height of the image in pixels."]
        pub fn height(&self) -> u32 => ffi::vlImageGetHeight(self.pointer),
        #[doc = "Returns the depth of the image in pixels."]
        pub fn depth(&self) -> u32 => ffi::vlImageGetDepth(self.pointer),

        #[doc = "Returns the frame count of the image."]
        pub fn frame_count(&self) -> u32 => ffi::vlImageGetFrameCount(self.pointer),
        #[doc = "Returns the face count of the image."]
        pub fn face_count(&self) -> u32 => ffi::vlImageGetFaceCount(self.pointer),
        #[doc = "Returns the number of mip levels in the image."]
        pub fn mipmap_count(&self) -> u32 => ffi::vlImageGetMipmapCount(self.pointer),

        #[doc = "Returns the start frame of the image."]
        pub fn start_frame(&self) -> u32 => ffi::vlImageGetStartFrame(self.pointer),

        #[doc = "Returns the image flags."]
        pub fn flags(&self) -> ImageFlags => ImageFlags::from_bits_truncate(ffi::vlImageGetFlags(self.pointer)),

        #[doc = "Check if the given flag is set."]
        #[allow(clippy::cast_possible_wrap)]
        pub fn flag(&self, flag: ImageFlags) -> bool => ffi::vlImageGetFlag(self.pointer, flag.bits() as i32) == ffi::vlTrue,

        #[doc = "Returns the bump scale value."]
        pub fn bumpmap_scale(&self) -> f32 => ffi::vlImageGetBumpmapScale(self.pointer),

        #[doc = "Returns the format of the image."]
        #[doc = "Returns `None` if the format is unknown or if an image is not loaded."]
        pub fn format(&self) -> Option<ImageFormat> => ImageFormat::from_ffi(ffi::vlImageGetFormat(self.pointer)),

        #[doc = "Check whether the current image has a thumbnail."]
        pub fn has_thumbnail(&self) -> bool => ffi::vlImageGetHasThumbnail(self.pointer) == ffi::vlTrue,
        #[doc = "Returns the width the thumbnail in pixels."]
        pub fn thumbnail_width(&self) -> u32 => ffi::vlImageGetThumbnailWidth(self.pointer),
        #[doc = "Returns the height the thumbnail in pixels."]
        pub fn thumbnail_height(&self) -> u32 => ffi::vlImageGetThumbnailHeight(self.pointer),
        #[doc = "Returns the format of the thumbnail."]
        #[doc = "Returns `None` if the format is unknown or if there is no thumbnail."]
        pub fn thumbnail_format(&self) -> Option<ImageFormat> => ImageFormat::from_ffi(ffi::vlImageGetThumbnailFormat(self.pointer)),

        #[doc = "Check whether the current VTF version supports resources."]
        pub fn supports_resource(&self) -> bool => ffi::vlImageGetSupportsResources(self.pointer) == ffi::vlTrue,
        #[doc = "Returns the number of resource contained within the VTF file."]
        pub fn resource_count(&self) -> u32 => ffi::vlImageGetResourceCount(self.pointer),
        ...
        pub fn resource_type(&self, index: u32) -> Option<ResourceType> => ResourceType::from_ffi(ffi::vlImageGetResourceType(self.pointer, index) as i32),

        #[doc = "Check whether the resource of the given type exists."]
        pub fn has_resource(&self, resource: ResourceType) -> bool => ffi::vlImageGetHasResource(self.pointer, resource as u32) == ffi::vlTrue
    );

    ffi_setters! {
        #[doc = "Sets the start frame of the image."]
        pub fn set_start_frame(&mut self, start_frame: u32) => ffi::vlImageSetStartFrame(self.pointer, start_frame),
        #[doc = "Sets the flags of the image."]
        pub fn set_flags(&mut self, flags: ImageFlags) => ffi::vlImageSetFlags(self.pointer, flags.bits()),
        #[allow(clippy::cast_possible_wrap)]
        #[doc = "Sets the state of a specific flag in the image"]
        pub fn set_flag(&mut self, flag: ImageFlags, state: bool) => ffi::vlImageSetFlag(self.pointer, flag.bits() as i32, ffi_bool(state)),
        #[doc = "Sets the bump scale value."]
        pub fn set_bumpmap_scale(&mut self, scale: f32) => ffi::vlImageSetBumpmapScale(self.pointer, scale),
        #[doc = "Sets the reflectivity values of the image."]
        pub fn set_reflectivity(&mut self, x: f32, y: f32, z: f32) => ffi::vlImageSetReflectivity(self.pointer, x, y, z)
    }
    ...
    pub fn reflectivity(&self) -> (f32, f32, f32) {
        ...
        let mut z = 0.0;
        unsafe {
            ffi::vlImageGetReflectivity(self.pointer, &mut x, &mut y, &mut z);
        }
        (x, y, z)
    }
    ...
    pub unsafe fn data_unchecked(
        ...
        let data = ffi::vlImageGetData(self.pointer, frame, face, slice, mipmap_level);
        if data.is_null() {
            return None;
        }
    ...
    pub fn thumbnail_data(&self) -> Option<&[u8]> {
        ...
        unsafe {
            let data = ffi::vlImageGetThumbnailData(self.pointer);
            if data.is_null() {
                return None;
            }
            Some(slice::from_raw_parts(data, data_len))
    ...
    pub fn resource_data(&self, resource: ResourceType) -> Result<&[u8]> {
        ...
        let mut data_len = 0;
        unsafe {
            let data = VtfLibErrorWrapper::ffi_result(|error| {
                ffi::vlImageGetResourceData(self.pointer, resource as u32, &mut data_len, error)
            })?;
    ...
    pub fn set_resource_data(&mut self, resource: ResourceType, data: &[u8]) -> Result<()> {
        ...
        unsafe {
            VtfLibErrorWrapper::ffi_result(|error| {
                ffi::vlImageSetResourceData(
                    self.pointer,
                    resource as u32,
                    len,
    ...
    pub fn generate_thumbnail(&mut self) -> Result<()> {
        unsafe {
            VtfLibErrorWrapper::ffi_try(|error| {
                ffi::vlImageGenerateThumbnail(self.pointer, error)
            })?;
        }
        Ok(())
    }
    ...
    pub fn generate_all_normal_maps(
        ...
        unsafe {
            VtfLibErrorWrapper::ffi_try(|error| {
                ffi::vlImageGenerateAllNormalMaps(
                    self.pointer,
                    kernel_filter as i32,
                    height_conversion_method as i32,
                    normal_alpha_result as i32,
    ...
    pub fn generate_sphere_map(&mut self) -> Result<()> {
        unsafe {
            VtfLibErrorWrapper::ffi_try(|error| {
                ffi::vlImageGenerateSphereMap(self.pointer, error)
            })?;
        }
        Ok(())
    }
    ...
    pub fn compute_reflectivity(&mut self) -> Result<()> {
        unsafe {
            VtfLibErrorWrapper::ffi_try(|error| {
                ffi::vlImageComputeReflectivity(self.pointer, error)
            })?;
        }
        Ok(())
    }
...
impl Default for VtfFile {
    fn default() -> Self {
        Self::new()
    }
}

impl Drop for VtfFile {
    fn drop(&mut self) {
        unsafe {
            ffi::vlDestroyVTFFile(self.pointer);
        }
    }
}
...
#[must_use]
pub struct EmptyImageBuilder<'a> {
    vtf: &'a mut VtfFile,
    width: u32,
    height: u32,
    frames: u32,
...
impl<'a> EmptyImageBuilder<'a> {
    fn new(vtf: &'a mut VtfFile, width: u32, height: u32) -> Self {
        Self {
            vtf,
            width,
            height,
...
#[must_use]
pub struct Rgba8888ImageBuilder<'a> {
    vtf: &'a mut VtfFile,
    width: u32,
    height: u32,
